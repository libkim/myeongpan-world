...
- **도장 느낌** — 고무인을 종이에 찍은 인영을 흉내 냅니다. 테두리 요철, 잉크 고임, 압력 얼룩, 흰 점, 종이 결이
  들어가며 두 가지 스타일 중 고를 수 있습니다. 거친 인영은 테두리가 또렷하고 거칠고,
  번짐 인영은 경계가 부드럽고 잉크가 종이에 살짝 스며 있습니다.
- **최소한의 설정** — 가로 길이, 잉크 색(감청·먹·인주), 글꼴(나눔명조·고운바탕·나눔고딕),
  인영 스타일(거친 / 번짐), 기울기(똑바로 / 랜덤 기울기)만 고릅니다. 나머지는 서식 기준에 맞춰 고정돼 있습니다.
